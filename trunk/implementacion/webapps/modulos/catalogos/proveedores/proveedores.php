...
<div ng-controller="vistaProveedor">


<main class="app-content">
    <div class="app-title">
        <div>
          <h1><i class="fas fa-boxes"></i> LISTA DE PROVEEDORES</h1>
        </div>
                    ...
                    <!-- ESTTE CÓDIGO COMENTADO SERVIRÁ MÁS ADELANTE SI SE QUOERE AGREGAR LOS GRUPOS DE PERSONAS -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover"  id="tablaProveedor">
                                ...
                                <tbody>
                                    <tr ng-repeat="(i, obj) in proveedor ">
                                        <td class="text-center">{{obj.cve_alterna}}</td>
                                        <td >{{obj.nombre_proveedor}}</td>
                                        <td class="text-center">{{obj.razon_social}}</td>
                                        <td class="text-center">{{obj.rfc}}</td>
                                        <td class="text-center">{{obj.direccion}}</td>
                                        <td class="text-center">{{obj.colonia}}</td>
                                        <td class="text-center">{{obj.cp}}</td>
                                        <td class="text-center">{{obj.ciudad_estado}}</td>
                                        <td class="text-center">{{obj.dias_credito}}</td>
